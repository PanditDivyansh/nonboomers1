...
const Marquee = () => {
  return (
    <div data-scroll data-scroll-speed="0.008"  data-scroll-section className='w-full py-16 pb-20 mb-0 bg-orange-800 sm:rounded-tr-3xl sm:rounded-tl-3xl rounded-3xl'>
