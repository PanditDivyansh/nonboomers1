...
const Marquee = () => {
  return (
    <div data-scroll data-scroll-speed="0.2"  data-scroll-section className='w-full py-15 pb-20 mb-0 bg-orange-800 sm:rounded-tr-3xl sm:rounded-tl-3xl rounded-3xl'>
