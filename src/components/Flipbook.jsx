...
>
      ...
      <img className='absolute rotate-115 sm:left-[25%] left-[-30%] sm:top-460 top-[260%]  sm:w-100 w-65' src={pen}></img>
      <img className='absolute rotate-135 sm:left-[10%] sm:top-460 top-[280%]  sm:w-100 w-65' src={coffee}></img>
